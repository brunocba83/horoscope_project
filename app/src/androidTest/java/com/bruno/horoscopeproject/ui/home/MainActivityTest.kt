...
import com.bruno.horoscopeproject.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    fun when_mainactivity_is_created_then_open_luckfragment() {
        onView(withId(R.id.luckyFragment)).perform(click())

    }

    @Test
    fun when_horoscope_is_created_then_open_detail() {
